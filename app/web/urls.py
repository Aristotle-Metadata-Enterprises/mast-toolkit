...
urlpatterns = [
    path("", TemplateView.as_view(template_name="static/home.html"), name="home"),
    ...
    path("survey/manage/<survey_pk>/responses/metadata/csv", views.SurveyResponseMetadataDownloadView.as_view(), name="survey_download_response_metadata"),
    path("survey/manage/<survey_pk>/responses/metadata/ddi", views.SurveyResponseMetadataDDIDownloadView.as_view(), name="survey_download_response_metadata_ddi"),
    ...
    path("survey/manage/<survey_pk>/update/add_industry", views.SurveyAddIndustryView.as_view(), name="survey_manage_add_industry"),
    path("survey/manage/<survey_pk>/update/delete_industry/<industry_pk>", views.SurveyDeleteIndustryView.as_view(), name="survey_manage_delete_industry"),
